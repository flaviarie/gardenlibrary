...
<head>
    ...
    <title><?php echo $page_title; ?> - Librarian Dashboard - Purring Pages</title>    
    <!-- Tailwind CSS -->
    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div id="mobile-sidebar" class="fixed top-0 left-0 w-80 h-full bg-white shadow-xl sidebar-hidden transition-transform duration-300 ease-in-out z-50">
            ...
            <div class="flex items-center justify-between p-6 bg-gradient-to-r from-primary to-green-600 text-white">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-green-100">Librarian Portal</p>
                    </div>
                </div>
            ...
            <nav class="p-4 space-y-2">
                <!-- Dashboard -->
                <a href="<?php echo $base_path; ?>index.php" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-primary hover:text-white transition-colors duration-200 <?php echo ($current_page == 'index' && $current_dir == 'librarian') ? 'bg-primary text-white' : ''; ?>">
                    <i class="fas fa-chart-pie w-5"></i>
                    <span class="font-medium">Dashboard</span>
                </a>
                
                <!-- Manage Books -->
                <a href="<?php echo $base_path; ?>modules/manage_books.php" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-primary hover:text-white transition-colors duration-200 <?php echo ($current_page == 'manage_books') ? 'bg-primary text-white' : ''; ?>">
                    <i class="fas fa-book w-5"></i>
                    <span class="font-medium">Manage Books</span>
                </a>

                <!-- Issue & Returns -->
                <a href="<?php echo $base_path; ?>modules/issue_returns.php" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-primary hover:text-white transition-colors duration-200 <?php echo ($current_page == 'issue_returns') ? 'bg-primary text-white' : ''; ?>">
                    <i class="fas fa-exchange-alt w-5"></i>
                    <span class="font-medium">Issue & Returns</span>
                </a>

                <!-- Reports -->
                <a href="<?php echo $base_path; ?>modules/reports.php" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-primary hover:text-white transition-colors duration-200 <?php echo ($current_page == 'reports') ? 'bg-primary text-white' : ''; ?>">
                    <i class="fas fa-chart-bar w-5"></i>
                    <span class="font-medium">Reports</span>
                </a>

                <!-- Reservations -->
                <a href="<?php echo $base_path; ?>modules/reservation.php" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-primary hover:text-white transition-colors duration-200 <?php echo ($current_page == 'reservation') ? 'bg-primary text-white' : ''; ?>">
            ...
            <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200">
                <div class="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                        <p class="font-semibold text-gray-800"><?php echo isset($_SESSION['username']) ? htmlspecialchars($_SESSION['username']) : 'Librarian'; ?></p>
                ...
                <div class="flex items-center space-x-2 sm:space-x-4">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="px-3 py-1 bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 font-semibold rounded-full border border-green-200">
                            ...
                            <?php echo isset($_SESSION['username']) ? htmlspecialchars($_SESSION['username']) : 'Librarian'; ?>
                        </div>
                    </div>
                </div>            
            </header>            
